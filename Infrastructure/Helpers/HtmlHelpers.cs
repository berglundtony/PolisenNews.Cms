...
using PolisenNews.Cms.Infrastructure.Cms.Extensions;
...
namespace PolisenNews.Cms.Infrastructure.Helpers
{
    public static class HtmlHelpers
    {
            ...
            bool requirePageTemplate = true)
        {
            ...
            var descendants = contentLoader.GetDescendents(ContentReference.StartPage)
            ...
            var pagePath = descendants.Select(x => x.ContentLink)
                .Reverse()
